...
print_statement             : PRINT OPEN_PARENTHESIS expression CLOSED_PARENTHESIS          #printAST;
...
factor                      : literal                                                       #literalFactAST
                                | IDENTIFIER                                                #idFactAST
                                | IDENTIFIER DOT IDENTIFIER                                 #objectFactAST
...
literal                     : INT_LITERAL                                                   #intLiteralAST
                                | REAL_LITERAL                                              #realLiteralAST
                                | (TRUE | FALSE)                                            #boolLiteralAST
                                | STRING_LITERAL                                            #strLiteralAST
                                | CHAR_LITERAL                                              #charLiteralAST;
